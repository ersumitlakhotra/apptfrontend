...
const Footer = () => {
     ...
     const { apps} = AppIconsPermission('20px',20);
    return ( 
        <div class="sticky z-50 bottom-0 w-full flex flex-row justify-center items-center pb-3  ">
            ...
            <IsLoading isLoading={false} input={

    ...
    return (
        <div class='flex flex-col font-normal gap-2 mt-2'>
            ...
            <div class='flex items-center w-full gap-2'>
                <p class="font-semibold w-32">Fullname</p>
                {fullnameEdit ?
                    <div class='flex flex-row items-center justify-between gap-2 w-full'>
                        ...
                        <Button color="primary" variant="filled" shape="circle" icon={<CheckOutlined />} onClick={() => { setFullnamePrev(fullname); setFullnameEdit(false) }} />
                        <Button variant="filled" danger shape="circle" icon={<CloseOutlined />} onClick={() => { setFullname(fullnamePrev); setFullnameEdit(false) }} />
                    </div>
            ...
            <div class='flex items-center w-full gap-2'>
                ...
                {cellEdit ?
                    <div class='flex flex-row items-center justify-between gap-2 w-full'>
                        ...
                        <Button color="primary" variant="filled" shape="circle" icon={<CheckOutlined />} onClick={() => { setCellPrev(cell); setCellEdit(false) }} />
                        <Button variant="filled" danger shape="circle" icon={<CloseOutlined />} onClick={() => { setCell(cellPrev); setCellEdit(false) }} />
                    </div>
            ...
            <div class='flex items-center w-full gap-2'>
                ...
                {emailEdit ?
                    <div class='flex flex-row items-center justify-between gap-2 w-full'>
                        ...
                        <Button color="primary" variant="filled" shape="circle" icon={<CheckOutlined />} onClick={() => { setEmailPrev(email); setEmailEdit(false) }} />
                        <Button variant="filled" danger shape="circle" icon={<CloseOutlined />} onClick={() => { setEmail(emailPrev); setEmailEdit(false) }} />
                    </div>
            ...
            <div class='flex items-center w-full gap-2'>
                ...
                {addressEdit ?
                    <div class='flex flex-row items-center justify-between gap-2 w-full'>
                        ...
                        <Button color="primary" variant="filled" shape="circle" icon={<CheckOutlined />} onClick={() => { setAddressPrev(address); setAddressEdit(false) }} />
                        <Button variant="filled" danger shape="circle" icon={<CloseOutlined />} onClick={() => { setAddress(addressPrev); setAddressEdit(false) }} />
                    </div>
            ...
            <div class='flex items-center w-full gap-2'>
                ...
                {birthdayEdit ?
                    <div class='flex flex-row items-center justify-between gap-2 w-full'>
                        ...
                        <Button color="primary" variant="filled" shape="circle" icon={<CheckOutlined />} onClick={() => { setBirthdayPrev(birthday); setBirthdayEdit(false) }} />
                        <Button variant="filled" danger shape="circle" icon={<CloseOutlined />} onClick={() => { setBirthday(birthdayPrev); setBirthdayEdit(false) }} />
                    </div>
            ...
            <div class='flex items-center w-full gap-2'>
                ...
                {genderEdit ?
                    <div class='flex flex-row items-center justify-between gap-2 w-full'>
                        ...
                        <Button color="primary" variant="filled" shape="circle" icon={<CheckOutlined />} onClick={() => { setGenderPrev(gender); setGenderEdit(false) }} />
                        <Button variant="filled" danger shape="circle" icon={<CloseOutlined />} onClick={() => { setGender(genderPrev); setGenderEdit(false) }} />
                    </div>

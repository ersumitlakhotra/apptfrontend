...
const Header = () => {
  const items=ProfileItems;
    return (
        <div class='h-16 border border-gray-300 bg-white flex items-center justify-between px-5 w-full fixed top-0 left-0'>       
            ...
            <Dropdown menu={{ items }} overlayStyle={{width:'250px',gap:5}}>
                ...
                <Space>
                        <Avatar size={40} src={<img src='https://gw.alipayobjects.com/zos/rmsportal/KDpgvguMpGfqaHPjicRK.svg'></img>} />
                </Space>
                  </Link>
            </Dropdown>
        </div>
